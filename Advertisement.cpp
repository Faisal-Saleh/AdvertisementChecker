...
VideoAdvertisement::VideoAdvertisement(string& vid_path, string& log_path) {
...
ImageAdvertisement::ImageAdvertisement(string& img_path, string& log_path) {
...
// TODO: check if this affects the original image or if it stays the same.
